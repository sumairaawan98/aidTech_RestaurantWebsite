...
mysql_select_db("table1");
  if(isset($_POST['submit']))
  {
	$un = $_POST['name'];
	$pw = $_POST['password'];
 $sql = mysql_query("select password from table1 where name ='$un'");
...
<body>
  <!--------nav----------->
      ...
      <!-------logo--->
          ...
          <ul>
            <li>
              <a href="home.php">Menu <img src="home image/dropdown.png" /></a>
             <ul>
...
<font size="+7" color="#FFA500">LOG IN</font>
<form method="post" style="padding-top:100px">

<font color="#FFF" >
NAME &nbsp;&nbsp;<input type="text" name="name" autocomplete="off" required="required" style="font-size:16px"/><br /><br /><br />

PASSWORD<input type="password" name="password" required="required"/>
</font>
<br /><br /><br />
<input type="submit" name="submit" value="SUBMIT" style="width:100px;background-color:#F93;" required="required" style="font-size:16px"/>
</form>  
</div>
<!------------LGIN--------->
<!----------FOOOTER--------------->
