...
<div class="GRIDVIEW">
  ...
  <!----------Menu------> 
    ...
    <div class="DIV1">
    <img src="menu image/all/d1.jpg" />
    <center><font size="+2" color="#FFA500" style="margin-top:50px;line-height:40px">English-Asparagus  <br />
    $ 14.95
    </font>
    </center>
    </div>
